...
const links = [
  { label: 'Ecosystem', chevron: false },
  { label: 'Economics', chevron: true },
...
export default function Navbar() {
  return (
    <motion.nav
      ...
      className="w-full flex items-center justify-between px-6 md:px-10 py-6"
    >
      {/* Mobile logo */}
      ...
      <a
        href="#"
        className="group/demo flex items-center gap-2 rounded-full bg-[#1b2a4e] hover:bg-[#243a6b] pl-4 pr-1.5 py-1.5 text-white text-sm font-medium transition-colors"
      >
        Book Demo
